...
with st.sidebar:
    ...
    if st.button("AI 대화 초기화", use_container_width=True):
        reset_ai_conversation()
        st.toast("AI 대화를 초기화했어요.")
    ...
    with tab5:
        st.markdown(
            ...
            <div class="ai-hero">
                ...
                <div class="ai-title">🐶 파트라슈에게 말로 물어보세요</div>
                <div class="ai-desc">
        ...
        st.markdown(
            ...
            <div class="medical-note">
                ※ AI 케어파트라슈는 일반적인 반려견 돌봄 정보를 제공하는 데모 기능입니다.
